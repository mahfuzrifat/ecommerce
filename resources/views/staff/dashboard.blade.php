...
@section('content')
   {{--  <div class="container-fluid">
        @if(Auth::user()->phone == NULL && Auth::user()->photo == NULL )
 <div class="alert alert-warning" role="alert">
  Your profile isn't 100% complete.. Go to <a href="{{ route('admin.settings') }}" class="alert-link">SETTINGS</a> and complete your profile ..
</div>
@endif --}}
