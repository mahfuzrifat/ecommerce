   <div class="mini-cart-top">    
    ...
    <ul class="mini-cart-products">
        <li>
            <a class="image"><img src="assets/front/assets/images/product/product-1.png" alt="Product"></a>
            <div class="content">
        ...
        <li>
            <a class="image"><img src="assets/front/assets/images/product/product-2.png" alt="Product"></a>
            <div class="content">
        ...
        <li>
            <a class="image"><img src="assets/front/assets/images/product/product-3.png" alt="Product"></a>
            <div class="content">
